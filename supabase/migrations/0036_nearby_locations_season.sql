-- Surface season availability and boosted status in nearby_locations so
-- the Home page can filter/derive its "summer activities", "winter
-- activities", and "boosted" sections from a single query result.
