-- Surface the new city/country columns in nearby_locations so Search/Home
-- cards can render "address" and "city, country" as separate lines.
drop function if exists nearby_locations(double precision, double precision, integer, text[], text, text, text);
